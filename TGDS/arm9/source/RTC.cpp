...
u16 rtcRead(u32 address)
{
  ...
  //return ichfly_readu16extern((unsigned int)(address & 0x1FFFFFE));
	return 0;
}
            ...
            case 0x67:
              {
                ...
                */
				...
				rtcClockData.dataLen = 3;
                rtcClockData.data[0] = toBCD(getTime()->tm_hour);
                rtcClockData.data[1] = toBCD(getTime()->tm_min);
                rtcClockData.data[2] = toBCD(getTime()->tm_sec);
				rtcClockData.state = DATA;
