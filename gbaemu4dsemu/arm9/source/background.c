...
int bgInit_call_gbaemu4ds(int layer, BgType type, BgSize size, int mapBase, int tileBase) {
	...
	bgIsTextLut[layer] = false; //checkIfText(layer);   //dont care about libnds current mapped bg mode
...
int bgInitSub_call(int layer, BgType type, BgSize size, int mapBase, int tileBase) {
	...
	bgIsTextLut[layer + 4] = false; //checkIfText(layer + 4);
