  ...
  CASE_16(0x820)
    {
      ...
      address = STMW_myregs(opcode,temp,address,1, 0);
      address = STMW_myregs(opcode,temp,address,2, 1);
      address = STMW_myregs(opcode,temp,address,4, 2);
      address = STMW_myregs(opcode,temp,address,8, 3);
      address = STMW_myregs(opcode,temp,address,16, 4);
      address = STMW_myregs(opcode,temp,address,32, 5);
      address = STMW_myregs(opcode,temp,address,64, 6);
      address = STMW_myregs(opcode,temp,address,128, 7);
      address = STMW_myregs(opcode,temp,address,256, 8);
      address = STMW_myregs(opcode,temp,address,512, 9);
      address = STMW_myregs(opcode,temp,address,1024, 10);
      address = STMW_myregs(opcode,temp,address,2048, 11);
      address = STMW_myregs(opcode,temp,address,4096, 12);
      address = STMW_myregs(opcode,temp,address,8192, 13);
      address = STMW_myregs(opcode,temp,address,16384, 14);
      if(opcode & 32768) {
        CPUWriteMemory(address, myregs[15].I+4);
  ...
  CASE_16(0x860)
    {
      ...
      if(armMode == 0x11) {
        address = STMW_myregs(opcode,temp,address,256, R8_FIQ);
        address = STMW_myregs(opcode,temp,address,512, R9_FIQ);
        address = STMW_myregs(opcode,temp,address,1024, R10_FIQ);
        address = STMW_myregs(opcode,temp,address,2048, R11_FIQ);
        address = STMW_myregs(opcode,temp,address,4096, R12_FIQ);
      } else {
        address = STMW_myregs(opcode,temp,address,256, 8);
        address = STMW_myregs(opcode,temp,address,512, 9);
        address = STMW_myregs(opcode,temp,address,1024, 10);
      ...
      if(armMode != 0x10 && armMode != 0x1f) {
        address = STMW_myregs(opcode,temp,address,8192, R13_USR);
        address = STMW_myregs(opcode,temp,address,16384, R14_USR);
      } else {
        address = STMW_myregs(opcode,temp,address,8192, 13);
        address = STMW_myregs(opcode,temp,address,16384, 14);
      }
...
const volatile void emuInstrTHUMB(u16 opcode, u32 *R) 
{
