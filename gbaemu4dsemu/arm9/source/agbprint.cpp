...
*/
void debuggerWriteHalfWord(u32 addr, u16 value){
	CPUWriteHalfWord_stack(addr,value);
}
...
void agbPrintFlush()
{
  u16 get = debuggerReadHalfWord(0x9fe20fc,1);
  u16 put = debuggerReadHalfWord(0x9fe20fe,1);

  u32 address = (debuggerReadHalfWord(0x9fe20fa,1) << 16);
