...
//ARM7 only
#ifdef ARM7
extern inline void SendArm9Command(u32 command1, u32 command2, u32 command3, u32 command4);	//hardware IPC
#endif

//ARM9 only
#ifdef ARM9
extern inline void SendArm7Command(u32 command1, u32 command2, u32 command3, u32 command4);	//hardware IPC
#endif

extern void set_ppu_vcountline_irq(u8 vcount_line_irq);
