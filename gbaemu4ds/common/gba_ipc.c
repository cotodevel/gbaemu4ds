...
//misc
void arm7printdebug(char * charbufptr,int charbufsize){
	if(charbufsize < sizeof(GBAEMU4DS_IPC->charbuf)){
		//void * memcpy ( void * destination, const void * source, size_t num );
		memcpy((u32*)&GBAEMU4DS_IPC->charbuf[0],(u32*)charbufptr,charbufsize);
		SendArm9Command(0xc6760000,charbufsize,0x0,0x0);
	}
}
