...
extern uint32 	__ewram_start;
extern uint32	__ewram_end;
extern uint32 get_ewram_start();
extern sint32 get_ewram_size();


extern uint32 	__dtcm_start;
extern uint32 	__dtcm_top;
extern uint32 	get_dtcm_start();
extern sint32 	get_dtcm_size();

extern uint32 	__itcm_start;
extern uint32 	__itcm_end;
